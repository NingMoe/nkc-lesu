...
function v046(v022) {
	...
	var myvar = "<table cellspacing=0 cellpadding=0><tr><td align=center><table width=\"380px\" cellspacing=0 cellpadding=0><tr><form name=\""
					...
					+ "<div class=\"selectPanel\"><input id=\"answer\" class=\"niput\" style=\"border-bottom: 1px solid #22B26F; width: 80%; margin-bottom: 10px;font-size:23px;\" name=\"number\" type=text maxlength="
					+ this.v018
					+ " size="
					+ this.v018
					+ " value="
