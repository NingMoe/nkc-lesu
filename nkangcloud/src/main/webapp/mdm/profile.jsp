...
function mesSend(){
	...
	$("body").append("<div id='sendR'>"
			...
			+"  <div class='rcommon' style='height:160px;margin-bottom: 8px;'><div class='imgSelect'><input type='checkbox' class='imgCB' checked='true'><img src='http://leshucq.bj.bcebos.com/standard/standard_leshuslide3.jpg'></div><div class='imgSelect'><input type='checkbox' class='imgCB'><img src='http://leshucq.bj.bcebos.com/standard/standard_leshuslide1.jpg'></div><div class='imgSelect'><input type='checkbox' class='imgCB'><img src='http://leshucq.bj.bcebos.com/standard/standard_leshuslide2.jpg'></div><div class='imgSelect'><input type='checkbox' class='imgCB'><img src='http://leshucq.bj.bcebos.com/standard/standard_leshuslide4.jpg'></div><div class='imgSelect'><input type='checkbox' class='imgCB'><img src='http://leshucq.bj.bcebos.com/standard/standard_leshuslide5.jpg'></div><div class='imgSelect'><input type='checkbox' class='imgCB'><img src='http://leshucq.bj.bcebos.com/standard/standard_leshuapp.jpg'></div><div class='imgSelect'><input type='checkbox' class='imgCB'><img src='http://leshucq.bj.bcebos.com/standard/classunitmgtbig.JPG'></div><div class='imgSelect'><input type='checkbox' class='imgCB'><img src='http://leshucq.bj.bcebos.com/standard/standard_registerherepls.jpg'></div></div>"
			...
			+"	<div class='rcommon'><textarea id='content' style='height:250px;width:95%;line-height:20px;border: 1px solid black;padding-left:5px;padding-top:5px;' placeholder='请输入内容' class='input-xlarge bsBtn'></textarea></div>"
			+"	<div class='rcommon' ><button style='margin-top:10px;width:95%;background:#20b672;text-shadow:none;color:white!important;' onclick='postNotification()' name='doublebutton-0' class='btn'>提交</button></div></div>"
			+"	</div>"
